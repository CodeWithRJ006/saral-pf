...
const startTag = '<div className="flex justify-between items-center mb-8 md:mb-12 border-b border-[#131215]/10 pb-4">';
const endTag = 'Track this request\n                      </button>\n                    </div>\n                  )}';
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  content = content.substring(0, startIndex) + newModalJSX + content.substring(endIndex);
  fs.writeFileSync('src/app/(app)/claims/page.tsx', content);
  console.log("Success replacing modal block.");
} else {
